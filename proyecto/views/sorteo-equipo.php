                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-8">
                            ...
                            <p>Sugiere un artículo nuevo para intercambiar, recuerda que su precio (múltiplos de 10) debe estar en un rango aproximado dentro de lo estipulado como el rango de precios permitidos para intercambiar</p>
                            <form id="formUsuarioArticulo">

                                <input type="hidden" name="idusuario" id="idusuario">
                                <div class="form-group row">
                                    <label for="nombre" class="col-md-4 col-form-label">Nombre de Artículo</label>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Agrega un artículo existente</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-8">
                            ...
                            <p>Sugiere un artículo de una lista para intercambiar con un precio aproximado dentro del rango estipulado de precios permitidos para el intercambio</p>
                            ...
                            <form id="formListaArticulo">
                                ...
                                <div class="form-group row">
                                    <label for="nombre" class="col-md-4 col-form-label">Artículo</label>

            ...
            <div class="row">
                ...
                <div class="col-md-8 col-xl-9 wow bounceIn" data-wow-delay=".3s">
                    ...
                    <!--<p>Todos en un equipo se conocen, todos saben o pueden intuir los gustos de los demas, esta es una forma en que podemos asegurar
                        ...
                        <p>Deseamos que el regalo que recibas de intercambio este año, sea el que nunca creiste porder recibir.</p>
                        <p>Participa votando por el regalo perfecto para ti y para cada integrante del intercambio.</p>
                </div>
